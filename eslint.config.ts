...
const CONFIGURATION = defineConfig(
	...
	// ─── Custom Rules ─────────────────────────────────────────────────────────────
	{
		rules: {
			...
			'@typescript-eslint/unbound-method': 'off', // Svelte passes methods as references (on:click={handler}); this rule false-positives because Svelte handles binding internally
